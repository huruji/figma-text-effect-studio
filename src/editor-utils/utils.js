export const TextEditorUtil = {
  hexToRgb: function (_0x258134) {
    const _0x2f92f1 = _0x258134.substring(1).match(/.{1,2}/g);
    const _0xbea63 = {
      r: parseInt(_0x2f92f1[0], 16),
      g: parseInt(_0x2f92f1[1], 16),
      b: parseInt(_0x2f92f1[2], 16)
    };
    if (_0x2f92f1.length === 4) {
      _0xbea63.a = parseInt(_0x2f92f1[3], 16) / 255;
    }
    Object.keys(_0xbea63).map(function (_0x46ebd8, _0x5bc851) {
      if (isNaN(_0xbea63[_0x46ebd8])) {
        _0xbea63[_0x46ebd8] = 0;
      }
    });
    return _0xbea63;
  },
  removeAllHexOpaqueAlpha: function (_0x432408) {
    return _0x432408.replace(/(#\w{6})ff/gi, "$1");
  },
  isIOS: function () {
    return /iPad|iPhone|iPod/.test(navigator.userAgent);
  },
  isHexColor: function (_0x230871) {
    return new RegExp("^#([0-9a-f]{6}|[0-9a-f]{3})$", "i").test(_0x230871);
  },
  rgbToHex: function (_0x1014a6) {
    let _0x5c1450 = "#" + (16777216 + (_0x1014a6.r << 16 | _0x1014a6.g << 8 | _0x1014a6.b)).toString(16).slice(1);
    if (_0x1014a6.a !== undefined) {
      const _0x4a7aed = Math.floor(_0x1014a6.a * 255);
      _0x5c1450 += (_0x4a7aed < 16 ? "0" : "") + _0x4a7aed.toString(16);
    }
    return _0x5c1450;
  },
  degrad: function (_0x324937) {
    return _0x324937 * Math.PI / 180;
  },
  exponentialCurve: function (_0x5e81d7, _0x104e44 = 100, _0x42a8fc = 4) {
    const _0x49c252 = Math.log(_0x5e81d7) / Math.log(_0x42a8fc);
    return Array(_0x5e81d7).fill(_0x104e44).map((_0x323136, _0x3b9623) => _0x323136 / Math.pow(_0x49c252, _0x3b9623));
  },
  generateUUID: function () {
    return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (_0x3a4139) {
      var _0x14024d = Math.random() * 16 | 0;
      return (_0x3a4139 == "x" ? _0x14024d : _0x14024d & 3 | 8).toString(16);
    });
  },
  mergeDeep: function (_0x226ebf, _0x2b7c60) {
    const _0x21e38a = function (_0x143880) {
      return _0x143880 && typeof _0x143880 == "object" && !Array.isArray(_0x143880);
    };
    if (_0x21e38a(_0x226ebf) && _0x21e38a(_0x2b7c60)) {
      for (const _0x5c30f7 in _0x2b7c60) {
        if (_0x21e38a(_0x2b7c60[_0x5c30f7])) {
          if (!_0x226ebf[_0x5c30f7]) {
            Object.assign(_0x226ebf, {
              [_0x5c30f7]: {}
            });
          }
          this.mergeDeep(_0x226ebf[_0x5c30f7], _0x2b7c60[_0x5c30f7]);
        } else {
          Object.assign(_0x226ebf, {
            [_0x5c30f7]: _0x2b7c60[_0x5c30f7]
          });
        }
      }
    }
  ...
  getBoundingSize: function (_0x521ed8, _0x515946) {
    if ((_0x515946 %= 180) < 0) {
      _0x515946 = 180 + _0x515946;
    }
    if (_0x515946 >= 90) {
      _0x521ed8 = [_0x521ed8[1], _0x521ed8[0]];
      _0x515946 -= 90;
    }
    if (_0x515946 === 0) {
      return {
    ...
    const _0x10eb1d = _0x515946 * Math.PI / 180;
    return {
      width: _0x521ed8[0] * Math.abs(Math.cos(_0x10eb1d)) + _0x521ed8[1] * Math.abs(Math.sin(_0x10eb1d)),
      height: _0x521ed8[0] * Math.abs(Math.sin(_0x10eb1d)) + _0x521ed8[1] * Math.abs(Math.cos(_0x10eb1d))
    };
  },
  cloneCanvas: function (_0x4f0c25) {
    const _0x1aeb2a = document.createElement("canvas");
    const _0x36debd = _0x1aeb2a.getContext("2d");
    _0x1aeb2a.width = _0x4f0c25.width;
    _0x1aeb2a.height = _0x4f0c25.height;
    _0x36debd.drawImage(_0x4f0c25, 0, 0);
    return _0x1aeb2a;
  },
...
export class ReplaceSVGColors {
  ...
  async parseColors(_0x34b187) {
    let _0x21d568 = TextEditorUtil.dataURLToSVGStr(_0x34b187);
    if (!_0x21d568) {
      throw new Error("Error while parse SVG string.");
    }
    this.alreadyParsed = _0x21d568.indexOf("data-already-parsed") !== -1;
    if (!this.alreadyParsed) {
      _0x21d568 = await TextEditorUtil.compressSVG(_0x21d568);
    }
    const _0x29e4f0 = new DOMParser().parseFromString(_0x21d568, "image/svg+xml");
    if (_0x29e4f0.querySelector("parsererror")) {
      throw new Error("Error while parse SVG string.");
    }
    this._svgDoc = _0x29e4f0;
    if (this.alreadyParsed) {
      this._resetElements();
    }
    this._colors ||= [];
  ...
  replaceColors(_0x53c09b) {
    const _0x2bd998 = this._getStyleTag();
    let _0xa07e13 = _0x2bd998.innerHTML;
    for (const _0x28bfd2 in _0x53c09b) {
      const _0xc78378 = _0x53c09b[_0x28bfd2];
      const _0x4fbd48 = new RegExp("." + _0xc78378.className + "{[^}]+}", "i");
      const _0x2ae804 = _0xa07e13.match(_0x4fbd48);
      const _0xa2cb68 = "." + _0xc78378.className + "{" + _0xc78378.type + ":" + _0xc78378.current + ";}";
      if (_0x2ae804) {
        _0xa07e13 = _0xa07e13.replace(_0x2ae804[0], _0xa2cb68);
      } else {
        _0xa07e13 += _0xa2cb68;
      }
    }
    _0x2bd998.innerHTML = _0xa07e13;
  }
  get colors() {
    return this._colors;
  }
  ...
  getDataURL() {
    const _0x7055f6 = this.getString();
    return "data:image/svg+xml;base64," + window.btoa(_0x7055f6);
  }
  _getStyleTag() {
    if (!this._styleTag) {
      const _0x458cb2 = this._svgDoc.documentElement.querySelector("style[data-replace-colors]");
      if (_0x458cb2) {
        this._styleTag = _0x458cb2;
      }
    }
    if (!this._styleTag) {
      ...
      this._svgDoc.documentElement.insertBefore(this._styleTag, parent.firstChild);
    }
    return this._styleTag;
  }
  _getColorFromClass(_0x57d70a) {
    const _0x38fc0e = this._getStyleTag().innerHTML;
    const _0x1cde4b = new RegExp("." + _0x57d70a + "{[^:]+:([^;]+);}", "i");
    const _0x3cd947 = _0x38fc0e.match(_0x1cde4b);
    if (_0x3cd947 && _0x3cd947.length > 1) {
      return _0x3cd947[1];
    }
  }
  _resetElements() {
    const _0x3c22d8 = this._fillElements.join(",");
    const _0x209424 = this._svgDoc.querySelectorAll(_0x3c22d8);
    for (const _0x2a97d2 of _0x209424) {
      const _0x4e3b7c = _0x2a97d2.getAttribute("class");
      if (_0x4e3b7c) {
        const _0x433382 = this._getColorFromClass(_0x4e3b7c);
        if (_0x433382) {
          _0x2a97d2.style.removeProperty("fill");
          _0x2a97d2.setAttribute("fill", _0x433382);
          _0x2a97d2.classList.remove(_0x4e3b7c);
        }
      }
    }
    const _0x127565 = this._strokeElements.join(",");
    const _0x55c3f3 = this._svgDoc.querySelectorAll(_0x127565);
    for (const _0x5afe16 of _0x55c3f3) {
      const _0x3e074b = _0x5afe16.getAttribute("class");
      if (_0x3e074b) {
        const _0x401b7b = this._getColorFromClass(_0x3e074b);
        if (_0x401b7b) {
          _0x5afe16.style.removeProperty("stroke");
          _0x5afe16.setAttribute("stroke", _0x401b7b);
          _0x5afe16.classList.remove(_0x3e074b);
        }
      }
    }
    const _0x328f08 = this._gradientElements.join(",");
    const _0xef5a1a = this._svgDoc.querySelectorAll(_0x328f08);
    for (const _0xe0150e of _0xef5a1a) {
      const _0x5e551e = _0xe0150e.getAttribute("class");
      if (_0x5e551e) {
        const _0x2bbb97 = this._getColorFromClass(_0x5e551e);
        if (_0x2bbb97) {
          _0xe0150e.style.removeProperty("stop-color");
          _0xe0150e.setAttribute("stop-color", _0x2bbb97);
          _0xe0150e.classList.remove(_0x5e551e);
        }
      }
    }
  ...
  _parseFillElements() {
    const _0x3c6c36 = [];
    const _0x237a58 = this._fillElements.join(",");
    const _0x15f908 = this._svgDoc.querySelectorAll(_0x237a58);
    for (const _0x3b5815 of _0x15f908) {
      let _0x36c413 = null;
      const _0x46c1c5 = _0x3b5815.style.fill;
      const _0x5695eb = this._trim(_0x3b5815.getAttribute("fill"));
      let _0x638c92 = this._trim(_0x3b5815.getAttribute("stroke"));
      if (_0x5695eb && _0x5695eb !== "#000000") {
        _0x36c413 = _0x5695eb;
      } else if (_0x46c1c5) {
        _0x36c413 = _0x46c1c5;
      } else if ((!_0x638c92 || _0x638c92 === "#000000") && _0x3c6c36.indexOf(_0x3b5815.parentNode) === -1 && !_0x3b5815.getAttribute("clip-path")) {
        _0x36c413 = "#000000";
      }
      if (_0x36c413 && (_0x36c413 = this._normalizeColor(_0x36c413), TextEditorUtil.isHexColor(_0x36c413))) {
        _0x3c6c36.push(_0x3b5815);
        _0x3b5815.style.removeProperty("fill");
        _0x3b5815.setAttribute("fill", _0x36c413);
        const _0x13a64d = this._generateClassName("color", _0x36c413);
        _0x3b5815.classList.add(_0x13a64d);
        if (!this._colorExists(_0x36c413, "fill")) {
          this._colors.push({
            current: _0x36c413,
            previous: _0x36c413,
            initial: _0x36c413,
  ...
  _parseStrokeElements() {
    const _0x2f8cfa = [];
    const _0xea4512 = this._strokeElements.join(",");
    const _0xf0d823 = this._svgDoc.querySelectorAll(_0xea4512);
    for (const _0x3bf648 of _0xf0d823) {
      let _0x4e0a4a = null;
      if (this.alreadyParsed) {
        _0x4e0a4a = this._getColorFromClass(_0x3bf648);
      }
      if (!_0x4e0a4a) {
        const _0x558f42 = _0x3bf648.style.stroke;
        const _0x1d83c3 = this._trim(_0x3bf648.getAttribute("stroke"));
        if (_0x1d83c3 && _0x1d83c3 !== "#000000") {
          _0x4e0a4a = _0x1d83c3;
        } else if (_0x558f42) {
          _0x4e0a4a = _0x558f42;
        }
      }
      if (_0x4e0a4a && (_0x4e0a4a = this._normalizeColor(_0x4e0a4a), TextEditorUtil.isHexColor(_0x4e0a4a))) {
        _0x2f8cfa.push(_0x3bf648);
        _0x3bf648.style.removeProperty("stroke");
        _0x3bf648.setAttribute("stroke", _0x4e0a4a);
        const _0xecd399 = this._generateClassName("colorStroke", _0x4e0a4a);
        _0x3bf648.classList.add(_0xecd399);
        if (!this._colorExists(_0x4e0a4a, "stroke")) {
          this._colors.push({
            current: _0x4e0a4a,
            previous: _0x4e0a4a,
            initial: _0x4e0a4a,
  ...
  _parseGradientElements() {
    const _0x1a68b9 = [];
    const _0x458653 = this._gradientElements.join(",");
    const _0x1c6d32 = this._svgDoc.querySelectorAll(_0x458653);
    for (const _0x5b8abf of _0x1c6d32) {
      let _0x33411f = null;
      if (this.alreadyParsed) {
        _0x33411f = this._getColorFromClass(_0x5b8abf);
      }
      if (!_0x33411f) {
        const _0x377f66 = this._trim(_0x5b8abf.getAttribute("stop-color"));
        _0x33411f = _0x377f66 || "#000000";
      }
      if (_0x33411f && (_0x33411f = this._normalizeColor(_0x33411f), TextEditorUtil.isHexColor(_0x33411f))) {
        _0x1a68b9.push(_0x5b8abf);
        _0x5b8abf.setAttribute("stop-color", _0x33411f);
        const _0xd0b5dd = this._generateClassName("stopColor", _0x33411f);
        _0x5b8abf.classList.add(_0xd0b5dd);
        if (!this._colorExists(_0x33411f, "stop-color")) {
          this._colors.push({
            current: _0x33411f,
            previous: _0x33411f,
            initial: _0x33411f,
  ...
  _generateClassName(_0x509b65, _0x3480f2) {
    return _0x509b65 + _0x3480f2.replace(/[\W+]/g, "");
  }
  _normalizeColor(_0x2d23fd) {
    if (/^#[0-9a-f]{3}$/i.test(_0x2d23fd)) {
      _0x2d23fd = "#" + _0x2d23fd.substring(1).split("").map(function (_0x4dd149) {
        return _0x4dd149 + _0x4dd149;
      }).join("");
    } else if (_0x2d23fd.indexOf("rgb(") !== -1) {
      _0x2d23fd = TextEditorUtil.rgbStringToHex(_0x2d23fd);
    } else if (ReplaceSVGColors.COLORNAMES[_0x2d23fd]) {
      _0x2d23fd = ReplaceSVGColors.COLORNAMES[_0x2d23fd];
    } else if (_0x2d23fd === "transparent" || _0x2d23fd === "none") {
      _0x2d23fd = null;
    }
    return _0x2d23fd;
  }
  _trim(_0x13d834) {
    if (_0x13d834) {
      return _0x13d834.trim();
    } else {
      return _0x13d834;
    }
  }
  _colorExists(_0x259c21, _0x26bc80) {
    for (const _0x56fae5 in this._colors) {
      if (this._colors[_0x56fae5].initial === _0x259c21 && this._colors[_0x56fae5].type === _0x26bc80) {
        return true;
      }
    }
    return false;
